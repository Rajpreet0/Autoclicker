...
class ClickMouse(threading.Thread):
    ...
    # method to check and run loop unitl it is true antoher loop will check
...
def on_press(key):
    ...
    if key == start_stop_key:
        if click_thread.running:
            ...
            click_thread.start_clicking()
    elif key == stop_key: # here exit method is called and when key is pressed it terminates auto clicker
        click_thread.exist()
        listener.stop()
